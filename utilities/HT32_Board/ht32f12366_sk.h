...
/** @addtogroup HT32F12366_SK_ITM
  * @{
  */
#define TRACESWO_GPIO_ID                   (GPIO_PA)
#define TRACESWO_AFIO_PIN                  (AFIO_PIN_11)
#define TRACESWO_AFIO_MODE                 (AFIO_FUN_SYSTEM)
/**
  * @}
  */
...
#define LCD_EBI_BL_GPIO_ID          (GPIO_PE)  // Share with LED3
#define LCD_EBI_BL_GPIO_PIN         (GPIO_PIN_2)
#define LCD_EBI_BL_AFIO_MODE        (AFIO_MODE_DEFAULT)
#define LCD_EBI_BL_CLK(CK)          (CK.Bit.PE)
