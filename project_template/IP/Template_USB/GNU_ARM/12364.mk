...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 12364
STARTUP = startup_ht32f1xxxx_gcc_03
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F12364_SK
C_OPTION += -DUSE_HT32F12364
C_OPTION += -DUSE_MEM_HT32F12364
S_OPTION = --defsym USE_HT32_CHIP=16
...
SOURCE_NAME_PATH += ../system_ht32f1xxxx_03.c
...
$(HT32_LIB_PATH)ht32f1xxxx_adc_02.c \
$(HT32_LIB_PATH)ht32f1xxxx_aes.c \
