...
void ADC_Configuration(void)
{
  ...
  AFIO_GPxConfig(HTCFG_AD2_GPIO_ID, HTCFG_AD2_AFIO_PIN, AFIO_FUN_ADC0);
  AFIO_GPxConfig(HTCFG_AD3_GPIO_ID, HTCFG_AD3_AFIO_PIN, AFIO_FUN_ADC0);
  ...
  { /* ADC related settings                                                                                 */
    ...
    ADC_RegularGroupConfig(HT_ADC0, DISCONTINUOUS_MODE, 3, 2);
    ...
    ADC_RegularChannelConfig(HT_ADC0, HTCFG_AD2_ADC_CH, 1, 0);
    ADC_RegularChannelConfig(HT_ADC0, HTCFG_AD3_ADC_CH, 2, 0);

    /* Set EXTI channel n as ADC trigger source                                                             */
    ADC_RegularTrigConfig(HT_ADC0, HTCFG_ADC_TRIG_EXTI);
  }

  /* Enable ADC cycle and subgroup end of conversion interrupt                                              */
  ADC_IntConfig(HT_ADC0, ADC_INT_CYCLE_EOC | ADC_INT_SUB_GROUP_EOC, ENABLE);
