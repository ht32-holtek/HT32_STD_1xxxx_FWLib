...
void ADC_Configuration(void)
{
  ...
  { /* ADC related settings                                                                                 */
    ...
    ADC_RegularChannelConfig(HT_ADC0, HTCFG_VR_ADC_CH, 0, 36);
    ADC_RegularChannelConfig(HT_ADC0, HTCFG_AD2_ADC_CH, 1, 36);
    ADC_RegularChannelConfig(HT_ADC0, HTCFG_AD3_ADC_CH, 2, 36);
