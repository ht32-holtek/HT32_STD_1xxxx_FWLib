/*********************************************************************************************************//**
 * @file    ADC/AnalogWatchdog/ht32f1xxxx_01_it.c
 * @version $Rev:: 2051         $
...
{
  if (ADC_GetIntStatus(HT_ADC0, ADC_INT_AWD_LOWER))
  {
    ADC_ClearIntPendingBit(HT_ADC0, ADC_INT_AWD_LOWER);
    HT32F_DVB_LEDOn(HT_LED2);
    HT32F_DVB_LEDOff(HT_LED1);
  }

  if (ADC_GetIntStatus(HT_ADC0, ADC_INT_AWD_UPPER))
  {
    ADC_ClearIntPendingBit(HT_ADC0, ADC_INT_AWD_UPPER);
