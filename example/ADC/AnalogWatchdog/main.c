...
void ADC_Configuration(void)
{
  ...
  ADC_AWDSingleChannelConfig(HT_ADC0, HTCFG_VR_ADC_CH);
  ADC_AWDConfig(HT_ADC0, ADC_AWD_SINGLE_LOWER_UPPER);  /* Enable upper/lower threshold monitor              */
  ADC_AWDThresholdsConfig(HT_ADC0, 3000, 1000);        /* Upper threshold 3000, lower threshold 1000        */

  /* Enable ADC Analog Watchdog lower and upper threshold interrupt                                         */
  ADC_IntConfig(HT_ADC0, ADC_INT_AWD_LOWER | ADC_INT_AWD_UPPER, ENABLE);
