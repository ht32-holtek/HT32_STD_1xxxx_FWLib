...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_FUN_BUTTON_EXTI_IRQ                  (EXTI1_IRQHandler)
  #define HTCFG_EXTI_CH                              (EXTI_CHANNEL_1)
  #define HTCFG_RESET_LED(Reset)                     (Reset.Bit.PD)
#endif
  ...
  #define HTCFG_FUN_BUTTON_EXTI_IRQ                  (EXTI4_IRQHandler)
  #define HTCFG_EXTI_CH                              (EXTI_CHANNEL_4)
  #define HTCFG_RESET_LED(Reset)                     (Reset.Bit.PC)
#endif

#if defined(USE_HT32F12365_66)
  #define HTCFG_FUN_BUTTON_EXTI_IRQ                  (EXTI13_IRQHandler)
  #define HTCFG_EXTI_CH                              (EXTI_CHANNEL_13)
  #define HTCFG_RESET_LED(Reset)                     (Reset.Bit.PD)
#endif

#if defined(USE_HT32F12364)
  #define HTCFG_FUN_BUTTON_EXTI_IRQ                  (EXTI9_IRQHandler)
  #define HTCFG_EXTI_CH                              (EXTI_CHANNEL_9)
  #define HTCFG_RESET_LED(Reset)                     (Reset.Bit.PC)
#endif
