...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define I2C_SLAVE_PORT             (HT_I2C1)
  #define I2C_SLAVE_SCL_GPIO_ID      (GPIO_PD)
  #define I2C_SLAVE_SCL_AFIO_PIN     (AFIO_PIN_1)
  #define I2C_SLAVE_SDA_GPIO_ID      (GPIO_PD)
  #define I2C_SLAVE_SDA_AFIO_PIN     (AFIO_PIN_2)
#endif
