...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_OUTPUT_LED0_AFIO_PIN                            (AFIO_PIN_11)
  #define HTCFG_OUTPUT_LED1_AFIO_PIN                            (AFIO_PIN_0)
  #define HTCFG_OUTPUT_LED2_AFIO_PIN                            (AFIO_PIN_10)
  #define HTCFG_INPUT_WAKE_AFIO_PIN                             (AFIO_PIN_15)
  #define HTCFG_INPUT_KEY1_AFIO_PIN                             (AFIO_PIN_9)
  #define HTCFG_INPUT_KEY2_AFIO_PIN                             (AFIO_PIN_6)

  #define HTCFG_OUTPUT_LED0_GPIO_PIN                            (GPIO_PIN_11)
  #define HTCFG_OUTPUT_LED1_GPIO_PIN                            (GPIO_PIN_0)
  #define HTCFG_OUTPUT_LED2_GPIO_PIN                            (GPIO_PIN_10)
  #define HTCFG_INPUT_WAKE_GPIO_PIN                             (GPIO_PIN_15)
  #define HTCFG_INPUT_KEY1_GPIO_PIN                             (GPIO_PIN_9)
  #define HTCFG_INPUT_KEY2_GPIO_PIN                             (GPIO_PIN_6)
#endif
