...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SMARTCARD_CMD_GPIO_PIN        (GPIO_PIN_7)
  #define HTCFG_SMARTCARD_CMD_AFIO_PIN        (AFIO_PIN_7)
  #define HTCFG_SMARTCARD_CMD_AFIO_MODE       (AFIO_FUN_GPIO)
  #define HTCFG_SMARTCARD_CMD_CLK(CK)         (CK.Bit.PC)
  #define HTCFG_SMARTCARD_RSTN_GPIO_ID        (GPIO_PC)
  #define HTCFG_SMARTCARD_RSTN_GPIO_PIN       (GPIO_PIN_8)
  #define HTCFG_SMARTCARD_RSTN_AFIO_PIN       (AFIO_PIN_8)
  #define HTCFG_SMARTCARD_RSTN_AFIO_MODE      (AFIO_FUN_GPIO)
