...
The UxART_CLK frequency is set to maximum speed.
 
The USART baud rate is set to 115200 bps.

USART will print "Hello World!" string 10 times to the terminal software.

Then USART/UART will get character from the terminal software and show again on the screen.
