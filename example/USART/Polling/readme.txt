...
This example describes how to get data from or put data to USART/UART by polling mode.

The USART/UART baud rate is set to 115200 bps.

USART will read data from Rx buffer and then write the data to Tx buffer via polling mode.

This example also shows Blocking / Non-Blocking mode of USART/UART Rx data.
