...
/* Settings ------------------------------------------------------------------------------------------------*/
#define SD_SPI_PORT                       (HT_SPI1)
#define SD_SPI_DIV                        (SystemCoreClock/400000)    /* Fixed 400 kHz                      */
#define SD_SPI_DIV_HIGHSPEED              (SystemCoreClock/HTCFG_SD_MAXSPEED)
#define SD_BLOCK_SIZE                     (512)

#define SD_CS_PORT                        HTCFG_SD_SELECT
#define SD_CS_PIN                         HTCFG_SD_SELECT_PIN
...
#define SD_CD_READ()                      HTCFG_SD_CD_READ()
