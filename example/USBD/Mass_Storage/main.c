...
void CKCU_Configuration(void)
{
  ...
  HTCFG_SD_SELECT_PIN_CLK(CKCUClock)              = 1;
...
void GPIO_Configuration(void)
{
  ...
  /*--------------------------------------------------------------------------------------------------------*/
  AFIO_GPxConfig(HTCFG_SD_SCK_PIN_ID, HTCFG_SD_SCK_PIN, AFIO_MODE_5);
  AFIO_GPxConfig(HTCFG_SD_MOSI_PIN_ID, HTCFG_SD_MOSI_PIN, AFIO_MODE_5);
  AFIO_GPxConfig(HTCFG_SD_MISO_PIN_ID, HTCFG_SD_MISO_PIN, AFIO_MODE_5);

  /*  Configure SPI SEL pin                                                                                 */
  GPIO_SetOutBits(HTCFG_SD_SELECT, HTCFG_SD_SELECT_PIN);
  GPIO_DirectionConfig(HTCFG_SD_SELECT, HTCFG_SD_SELECT_PIN, GPIO_DIR_OUT);

  #if defined(HTCFG_SD_CD)
  /* SD Card detection function                                                                             */
  GPIO_DirectionConfig(HTCFG_SD_CD, HTCFG_SD_CD_PIN, GPIO_DIR_IN);
  GPIO_InputConfig(HTCFG_SD_CD, HTCFG_SD_CD_PIN, ENABLE); 
  #endif
}
