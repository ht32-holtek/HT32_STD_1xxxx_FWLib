...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_SD_MAXSPEED                             (36000000)
  ...
  #define HTCFG_SD_CD_READ()                            (HTCFG_SD_CD->DINR & HTCFG_SD_CD_PIN)
#endif
  ...
  /* !!! NOTICE !!!
     To use SD card, the manual connections between Starter Kit and Expansion Board are required, since the
     default mode is SDIO.
  */
  //#define HTCFG_SD_ENABLE_DISK
  #define HTCFG_SD_MAXSPEED                             (24000000)     //Reduce the maximum SPI speed since the manual connections.
  #define HTCFG_SDISK_READ_BUFFER                       (1024 * 4)
  ...
  */
  ...
  //#define HTCFG_USBPRE_DIV                              (CKCU_USBPRE_DIV1)
  ...
  #define HTCFG_SD_SELECT_PIN_CLK(CK)                   (CK.Bit.PA)
  #define HTCFG_SD_SELECT                               (HT_GPIOA)
  #define HTCFG_SD_SELECT_PIN                           (AFIO_PIN_1)

  #define HTCFG_SD_SCK_PIN_ID                           (GPIO_PA)
  #define HTCFG_SD_SCK_PIN                              (AFIO_PIN_4)

  #define HTCFG_SD_MOSI_PIN_ID                          (GPIO_PA)
  #define HTCFG_SD_MOSI_PIN                             (AFIO_PIN_5)

  #define HTCFG_SD_MISO_PIN_ID                          (GPIO_PA)
  #define HTCFG_SD_MISO_PIN                             (AFIO_PIN_6)
