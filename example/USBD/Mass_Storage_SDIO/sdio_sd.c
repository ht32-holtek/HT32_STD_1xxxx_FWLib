/*********************************************************************************************************//**
 * @file    USBD/Mass_Storage_SDIO/sdio_sd.c
 * @version $Rev:: 3508         $
...
#define SDIO_HIGH_SPEED_CLK_DIV         ((u32)6)
#define SDIO_NORMAL_SPEED_CLK_DIV       ((u32)7)
...
/* Global functions ----------------------------------------------------------------------------------------*/
/*********************************************************************************************************//**
  * @brief  Debug dump function.
  * @param  data: message to be print
