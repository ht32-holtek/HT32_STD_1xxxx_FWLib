/**
 @page USBD_Mass_Storage_SDIO

 @verbatim
 * @file    USBD/Mass_Storage_SDIO/readme.txt
 * @version V1.00
 * @date    2019-09-11
 * @brief   Description of USB Device Mass Storage and SDIO examples.
 @endverbatim
...
of BOT is as below.
The SD card reader function is implemented by SDIO.

!!! NOTICE !!!
  The SD_CMD, SD_DAT0, SD_DAT1, SD_DAT2, and SD_DAT3 signals require external 10K pull-up resistors.
  If data transmission errors occur at high-speed operation, try lowering the SDIO clock speed by
  adjusting "SDIO_HIGH_SPEED_CLK_DIV".
...
- USBD/Mass_Storage/sdio_sd.c                                 SD Card raw access function
- USBD/Mass_Storage/sdio_sd.h                                 Header file of SD Card

@par Hardware and Software Environment:
This example can be run on HT32 Series development board. This example uses the following endpoints.
Those SDIO's IO includes CMD, DAT0, DAT1, DAT2, and DAT3 all need to be pulled up by 10K. Refer
"utilities/HT32_Board/ht32f1xxxx_sk.h" for pin assignment.
<PRE>
