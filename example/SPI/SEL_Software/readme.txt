...
for slave select. Both SPIs are configured with 8 bits mode, non-FIFO mode, (PCLK_SPI/8) MHz transmission speed.
...
- SPI/SEL_Software/ht32fxxxxx_nn_it.c     Interrupt handlers
