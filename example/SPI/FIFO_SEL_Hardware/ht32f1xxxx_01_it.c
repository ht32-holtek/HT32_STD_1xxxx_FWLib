/*********************************************************************************************************//**
 * @file    SPI/FIFO_SEL_Hardware/ht32f1xxxx_01_it.c
 * @version $Rev:: 2352         $
...
void SPI0_IRQHandler(void)
{
  ...
  if (SPI_GetFlagStatus(HT_SPI0, SPI_FLAG_TOUT))
  {
    SPI_ClearFlag(HT_SPI0, SPI_FLAG_TOUT);
    bIsRxDataReady = TRUE;
  }
  ...
  {
    u32 uCount = SPI_GetFIFOStatus(HT_SPI0, SPI_FIFO_RX);
    ...
    */
    SPI_IntConfig(HT_SPI0, SPI_INT_RXBNE, DISABLE);
...
void SPI1_IRQHandler(void)
{
  ...
  /* Timeout: Clear Timeout Flag                                                                            */
  if (SPI_GetFlagStatus(HT_SPI1, SPI_FLAG_TOUT))
  {
    SPI_ClearFlag(HT_SPI1, SPI_FLAG_TOUT);
    bIsRxDataReady = TRUE;
  }
  ...
  if (bIsRxDataReady == TRUE)
  {
    u32 uCount = SPI_GetFIFOStatus(HT_SPI1, SPI_FIFO_RX);
    ...
    /* !!! NOTICE !!!
       ...
       the SPI interrupt again.
    */
    SPI_IntConfig(HT_SPI1, SPI_INT_RXBNE, DISABLE);
