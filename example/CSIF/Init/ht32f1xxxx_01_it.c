/*********************************************************************************************************//**
 * @file    CSIF/Init/ht32f1xxxx_01_it.c
 * @version $Rev:: 2976         $
...
void PDMA_CH0_IRQHandler(void)
{
  ...
  {
    /* Clear PDMA channel 0 transfer complete flag */
...
{
  if (CSIF_GetFlagStatus(CSIF_FLAG_BADFRAME))
  {
    /* Initialize LDE1, LED2 & LED3 */
