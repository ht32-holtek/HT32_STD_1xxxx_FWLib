/*********************************************************************************************************//**
 * @file    CMP/InternalReference/ht32f1xxxx_01_it.c
 * @version $Rev:: 2976         $
...
{
  if (CMP_GetFlagStatus(HT_CMP1, CMP_FLAG_FE))
  {
    CMP_ClearFlag(HT_CMP1, CMP_FLAG_FE);
    HT32F_DVB_LEDOff(HT_LED1);
  }

  if (CMP_GetFlagStatus(HT_CMP1, CMP_FLAG_RE))
  {
    CMP_ClearFlag(HT_CMP1, CMP_FLAG_RE);
