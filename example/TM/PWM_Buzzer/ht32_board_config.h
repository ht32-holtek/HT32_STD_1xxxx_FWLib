...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_BUZZER_GPIOX                     E
  #define _HTCFG_BUZZER_GPION                     15
  #define  HTCFG_BUZZER_IPN                       GPTM1
  #define  HTCFG_BUZZER_CHN                       0
#endif

#if defined(USE_HT32F12364_SK)
  #define _HTCFG_BUZZER_GPIOX                     F
  #define _HTCFG_BUZZER_GPION                     0
  #define  HTCFG_BUZZER_IPN                       PWM0
  #define  HTCFG_BUZZER_CHN                       1
#endif
