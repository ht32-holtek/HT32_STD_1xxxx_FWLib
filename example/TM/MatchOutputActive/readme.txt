...
-The GPTM0_PCLK frequency is set to 72 MHz or 80 MHz or 96 MHz  and the Prescaler is 10, so the GPTM0 counter clock is 7.2 MHz or 8.0 MHz or 9.6 MHz.
-The compare value is 7200 or 8000 or 9600 (GPTM0_CH3CCR), so the CH3 will output active level when the GPTM is enabled and
 the time passed 1 mS (7200 / 7.2 MHz or 8000 / 8.0 MHz or 9600 / 9.6 MHz).
