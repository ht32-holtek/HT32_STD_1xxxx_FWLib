...
void TM_Configuration(void)
{
  ...
  { /* Time base configuration                                                                              */
    ...
    */
    ...
    TimeBaseInit.Prescaler = TM_RRESCALER - 1;                         // Timer clock = CK_AHB / TM_RRESCALER
    TimeBaseInit.CounterReload = SystemCoreClock / TM_RRESCALER / TM_FREQ_HZ - 1;
