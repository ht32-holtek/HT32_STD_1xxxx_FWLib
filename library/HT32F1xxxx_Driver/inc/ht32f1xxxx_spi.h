...
#define SPI_SCK_HIGHDUTY_SHORTER                    ((u32)0x00008000)
#define SPI_SCK_HIGHDUTY_LONGER                     ((u32)0xFFFF7FFF)

#define IS_SPI_SCK_DUTY_MODE(SCKDUTY)               ((SCKDUTY == SPI_SCK_HIGHDUTY_SHORTER) || \
                                                     (SCKDUTY == SPI_SCK_HIGHDUTY_LONGER))
#endif
/**
  * @}
  */
